...
var torrent_infohash;
var torrent_name;
var torrent_name_beautify;
var torrent_length;
...
function onRecv(msg, rinfo) {
    ...
    if(data.y.toString() === 'r' && nCount < MAX_UDP_PER_SECOND) {
        ...
        // fetchMetadata(torrent_infohash, { maxConns: 10, fetchTimeout: 30000, socketTimeout: 5000 },
        // (err, metadata) => {
        //     if (err) {
        //         console.log(err);
        //         return;
        ...
        // try {
        //     torrent_name_beautify = ptn(torrent_name);
        // } catch {
        //     torrent_name_beautify = '';
        // }
        ...
        axios.post('https://www.dibumi.com/add.php', {
            ...
            name: torrent_name,
            // name_beautify: torrent_name_beautify,
